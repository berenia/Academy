    ...
    <AppBar position="static" style={classes.customizeAppbar}>
      <Container maxWidth="xl" disableGutters="false">
        <Toolbar style={classes.customizeToolbar}>
          ...
          {/* <Box sx={{ flexGrow: 1, display: { lg:'flex', xs: 'none' } , justifyContent: 'left', alignItems: 'right', flexDirection: 'row', background: '#000'}}>
            <OutlinedClickableLinkChips text={'Contact us'} /> 
            <OutlinedClickableLinkChips text={'Become an Instructor'}/> 
            <OutlinedClickableLinkChips text={'Partner with us'} />
        </Box> */}
